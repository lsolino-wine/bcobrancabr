...
module Bbrcobranca
  module Remessa
    module Cnab240
      class Base < Bbrcobranca::Remessa::Base
        # convenio do cedente
        ...
        def monta_header_arquivo
          ...
          header_arquivo << Bbrcobranca::Util::Empresa.new(documento_cedente, false).tipo # tipo inscricao                1
        ...
        def monta_header_lote(nro_lote)
          ...
          header_lote << Bbrcobranca::Util::Empresa.new(documento_cedente, false).tipo # tipo de inscricao       1
        ...
        #
        # @param pagamento [Bbrcobranca::Remessa::Pagamento]
        ...
        #
        def gera_arquivo
          raise Bbrcobranca::RemessaInvalida, self if invalid?
        ...
        def complemento_header
          raise Bbrcobranca::NaoImplementado, 'Sobreescreva este método na classe referente ao banco que você esta criando'
        end
