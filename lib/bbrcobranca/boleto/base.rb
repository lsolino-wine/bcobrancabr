...
module Bbrcobranca
  module Boleto
    ...
    class Base
      ...
      define_template(Bbrcobranca.configuration.gerador).each do |klass|
        extend klass
        include klass
      end

      # Validações
      include Bbrcobranca::Validations
      ...
      attr_accessor :linha_cabecalho1
      # <b>OPCIONAL</b>: Linha para texto acima do logo do banco
      ...
      #
      # @raise [Bbrcobranca::BoletoInvalido] Caso as informações fornecidas não sejam suficientes ou sejam inválidas.
