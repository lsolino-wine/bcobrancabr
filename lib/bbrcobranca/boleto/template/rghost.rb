  ...
  module Boleto
    module Template
      ...
      module Rghost
        ...
        RGhost::Config::GS[:external_encoding] = Bbrcobranca.configuration.external_encoding
        ...
        def modelo_generico(boleto, options = {})
          ...
          # Gerando stream
          formato = (options.delete(:formato) || Bbrcobranca.configuration.formato)
          resolucao = (options.delete(:resolucao) || Bbrcobranca.configuration.resolucao)
