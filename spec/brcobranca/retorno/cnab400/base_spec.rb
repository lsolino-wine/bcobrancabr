...
RSpec.describe Bbrcobranca::Retorno::Cnab400::Base do
  ...
  describe "#load_lines" do
    ...
    context "Bradesco" do
      ...
      subject { Bbrcobranca::Retorno::Cnab400::Bradesco }
    ...
    context "Itaú" do
      ...
      subject { Bbrcobranca::Retorno::Cnab400::Itau }
    ...
    context "Santander" do
      ...
      subject { Bbrcobranca::Retorno::Cnab400::Santander }
