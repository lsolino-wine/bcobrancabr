...
module Bbrcobranca
  module Remessa
    module Cnab400
      class BancoBrasil < Bbrcobranca::Remessa::Cnab400::Base
        #
        ...
        def monta_detalhe(pagamento, sequencial)
          ...
          detalhe << Bbrcobranca::Util::Empresa.new(documento_cedente).tipo    # tipo de identificacao da empresa  9[02] 002 a 003
